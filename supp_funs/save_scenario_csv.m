...
%     rho           numeric or char  feature correlation (e.g. 0.5 or 'NA')
...
%     csv_path  full path of the written CSV file
    ...
    provenance = table( ...
        ...
        repmat(string(rho_str),       n_rows, 1), ...
        repmat(rep,                   n_rows, 1), ...
    ...
    if ismember('Method', metrics_row.Properties.VariableNames)
        metrics_row = removevars(metrics_row, 'Method');
    end
